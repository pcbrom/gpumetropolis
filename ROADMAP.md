...
- 0.7.0 (delivered 2026-08-05): per-column marginal auto-selection,
  `gpum_fit_catalog()`. Support and modality detection, ten families
  (real-line, positive, unit, and the two-component mixture), ranked by
  WAIC, with the fitted CDF exposed by `marginal_cdf()` for the copula
